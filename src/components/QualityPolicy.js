                ...
                <section id="quality-policy">
                    <div className="container">
                            ...
                            <div className="col-md-12 text-center card">
                                <div>
                                    <ul className="text-left quality-policy-text">
                                        ...
                                        <li>To develop annual plan for QA/QI in linewith quality assurance and improvement plan as per the National Quality assurance standards</li>
                        ...
                        <div className="row">
                            ...
                            <div>
                                    <ul className="text-left quality-policy-text">
                                        <li>Medical Superindentent</li>
                                        <li>RMO</li>
                                        <li>Nursing Superindentent Grade - I</li>
